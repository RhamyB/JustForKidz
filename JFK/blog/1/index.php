						...
						<!-- Featured Post -->
							...
							<section class="posts">
								<article>
									...
									<a href="../mission.php" class="image fit"><img src="../../images/kids.png" alt="Kids" /></a>
									<p style="text-align: center;">Reasoning and statistics behind why we do what we do.</p>
									<ul class="actions">
										<li><a href="../mission.php" class="button">Full Story</a></li>
									</ul>
								</article>
							<!-- Posts
								<article>
