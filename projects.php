					...
					<div id="main">
						...
						<!-- Post -->
							...
							<section class="posts">
								<article>
									<header>
										<h2>Arusha, Tanzania<br />
										(2016-Present)</h2>
									</header>
									<span class="image fit"><img src="images/GoodHope.jpg" alt="Good Hope Orphanage" /></span>
