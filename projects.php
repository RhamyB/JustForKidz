					...
					<div id="main">
						...
						<!-- Post -->
							...
							<section class="posts">
								...
								<article>
									<header>
										<h2><a href="#">Port-au-Prince, Haiti<br />
										(2014-15)</a></h2>
									</header>
									<a href="#" class="image fit"><img src="images/pic03.jpg" alt="" /></a>
									<p>Just For Kidz collected clothing and shoes to donate to an orphanage in Port-au-Prince that helps about 30 boys and girls. Collecting a total of 4 boxes of clothes and shoes, the Founder personally delivered the clothes and shoes and distributed it among the children as their Christmas presents!</td>
								</article>
								<article>
									<header>
										<h2><a href="#">Chennai, India<br />
										(2011-16)</a></h2>
									</header>
								...
								<article>
									<header>
										<h2><a href="#">Walajapet, India<br />
										(2010-11)</a></h2>
									</header>
									<a href="#" class="image fit"><img src="images/pic05.jpg" alt="" /></a>
									<p>Just For Kidz fundraised $1,200 dollars to change the asbestos roof of Dheenabandu Ashram, a small orphanage that houses, teaches, and protects about 200 orphans and poor children in the village. The leaky roof prevented the students from attending class, caused heat stroke, and put them at risk for mesothelioma. Volunteers and donations completely maintain the orphanage, as the government only grants 10 cents per child per day.</p>
								</article>
							</section>
					</div>
